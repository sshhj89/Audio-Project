...
#define REC_BUTTON 12  // if you want to record, connect to gnd.
...
void setup() {
  ...
  if (!musicPlayer.begin()) {
    ...
    Serial.println(musicPlayer.sciRead(VS1053_REG_STATUS) );
    Serial.println(musicPlayer.sciRead(VS1053_REG_STATUS) >> 4);
    Serial.println((musicPlayer.sciRead(VS1053_REG_STATUS) >> 4) & 0x0F);
